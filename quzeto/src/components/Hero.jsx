...
const Hero = () => {
    return (
        <>
            ...
            <div className="container flex bg-[#FEF4E6] items-center lg:px-[7.5rem] py-10">
                <div className="grid md:grid-cols-2 items-center md:px-14 px-4 gap-x-8">
                    <div className="order-2 md:order-1">
                        <h1 className='font-bold lg:text-[2.7rem] lg:leading-[3.5rem] text-2xl py-2 text-[#324161]'>Easy and intuitive <br /> online testing</h1>
            ...
            <div className="container my-2 py-10 flex items-center lg:px-10 px-2 bg-[#FAFAFA]">
                <div className="grid md:grid-cols-2 lg:gap-x-20">
                    ...
                    <div className="md:pl-[4rem] pl-[1.5rem] order-1 md:order-2">
